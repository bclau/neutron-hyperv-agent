...
from cloudbase.neutron.hyperv import security_groups_driver as sg_driver
from cloudbase.neutron.hyperv import utilsfactory
from cloudbase.tests import base
...
class TestHyperVSecurityGroupsDriver(base.BaseTestCase):
    ...
    @mock.patch('cloudbase.neutron.hyperv.security_groups_driver'
